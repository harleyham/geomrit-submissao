...
Tipos comuns: palestra, seminário, mesa-redonda, minicurso, apresentação oral ou pôster e **atividades extras** (café da manhã, coffee break, brunch, almoço e jantar). As atividades extras funcionam como quaisquer outras (etapas, salas, chamada, certificados), a diferença é que **não podem ser marcadas como interesse** pelo participante. O formulário de atividade também permite definir o **número máximo de participantes** (vazio = sem limite) e se a **inscrição exige aprovação** da organização — a listagem administrativa mostra "Inscritos: N/M", com destaque "Vagas esgotadas" quando o limite é atingido (o administrador pode inscrever além do limite; o contador fica vermelho).
