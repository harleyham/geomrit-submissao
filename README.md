...
- **Papel Staff**: designado na página de Papéis do evento, opera o dia do evento com acesso restrito — marca e desfaz presença (manual, em lote e por QR) nas atividades e etapas e imprime listas de presença, folhas de QR Code de check-in e crachás com QR; não vê dashboard, usuários, artigos, relatórios, salas, certificados nem qualquer gestão do evento (rotas fora da operação de presença retornam Acesso negado)
